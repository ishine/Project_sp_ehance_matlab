...
W1_dB_values=zeros(length(f),length(eps_values));
W2_dB_values=zeros(length(f),length(eps_values));
W3_dB_values=zeros(length(f),length(eps_values));
W4_dB_values=zeros(length(f),length(eps_values));
