...
for idxM=1:length(M_values)
    ...
    for idx_f=1:length(f)
        ...
        Gamma0=sinc(2*fk*delta/c*(m_mat-n_mat));
        h=(Gamma0\d)/(d'/Gamma0*d);
        D4_dB_values(idx_f,idxM)=max(D4_dB_values(idx_f,idxM),10*log10(abs(h'*d)^2/(h'*Gamma0*h)));
        fk=f(idx_f)-2;
        d=exp(-1i*2*pi*fk*delta/c*(0:M-1)'*cos(theta_d));
        Gamma0=sinc(2*fk*delta/c*(m_mat-n_mat));
        h=(Gamma0\d)/(d'/Gamma0*d);
...
hold on
plot(f/1e3,D2_dB_values(:,1),'--g*','linewidth',linewd, 'MarkerSize',MarkerSize);
plot(f/1e3,D3_dB_values(:,1),':rs','linewidth',linewd, 'MarkerSize',MarkerSize);
plot(f/1e3,D4_dB_values(:,1),'-.c^','linewidth',linewd, 'MarkerSize',MarkerSize);
hold off
set(gca, 'Color', [1, 1, 1]);
...
figure
plot(f/1e3,D1_dB_values(:,2),'-bo','linewidth',linewd, 'MarkerSize',MarkerSize);
hold on
plot(f/1e3,D2_dB_values(:,2),'--g*','linewidth',linewd, 'MarkerSize',MarkerSize);
plot(f/1e3,D3_dB_values(:,2),':rs','linewidth',linewd, 'MarkerSize',MarkerSize);
plot(f/1e3,D4_dB_values(:,2),'-.c^','linewidth',linewd, 'MarkerSize',MarkerSize);
hold off
set(gca, 'Color', [1, 1, 1]);
set(gca, 'FontName', 'Times New Roman');
set(gca, 'FontSize', hcfontsize);
...
figure
plot(f/1e3,D1_dB_values(:,3),'-bo','linewidth',linewd, 'MarkerSize',MarkerSize);
hold on
plot(f/1e3,D2_dB_values(:,3),'--g*','linewidth',linewd, 'MarkerSize',MarkerSize);
plot(f/1e3,D3_dB_values(:,3),':rs','linewidth',linewd, 'MarkerSize',MarkerSize);
plot(f/1e3,D4_dB_values(:,3),'-.c^','linewidth',linewd, 'MarkerSize',MarkerSize);
hold off
set(gca, 'Color', [1, 1, 1]);
set(gca, 'FontName', 'Times New Roman');
set(gca, 'FontSize', hcfontsize);
...
figure
plot(f/1e3,D1_dB_values(:,4),'-bo','linewidth',linewd, 'MarkerSize',MarkerSize);
hold on
plot(f/1e3,D2_dB_values(:,4),'--g*','linewidth',linewd, 'MarkerSize',MarkerSize);
plot(f/1e3,D3_dB_values(:,4),':rs','linewidth',linewd, 'MarkerSize',MarkerSize);
