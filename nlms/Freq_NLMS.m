...
while (EndFrame < Len)
 ...
 audiowrite([fout '_nlms.wav'],Nlms_T,fs);

  fprintf('End of freq nlms\n');
 
 %audiowrite('f:/Work/2018/Beamforming/matlab/GSCLMS/FreqNlmsPred.wav',Nlms_T,fs);  
 %omlsa(fout);
 
  fprintf('End of freq omlsa\n');
